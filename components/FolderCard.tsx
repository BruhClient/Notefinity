...
export const FolderCard = ({id,name,username ,image , likes , comments ,createdAt} : {id : string,name : string , username : string , image : string | null , likes : number , comments : number,createdAt : Date}) => { 
    ...
    <Card>
        <CardContent className='flex gap-4 flex-col'>
            ...
            <div className='flex gap-2 flex-col'>
                ...
                <div className='flex gap-2 items-center'>
                    <div className='flex gap-2 items-center text-muted-foreground'>
                        <Skeleton className='w-5 h-5 rounded-lg'/> <Skeleton className='w-8 h-5 rounded-lg'/>
                    </div>
                    <div className='flex gap-2 items-center text-muted-foreground'>
                        <Skeleton className='w-5 h-5 rounded-lg'/> <Skeleton className='w-8 h-5 rounded-lg'/>
                    </div>

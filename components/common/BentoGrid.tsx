...
const messages = [
  ...
  },
  {
    role: "bot",
    message:
      "Neural networks are a type of machine learning model inspired by how the human brain works. They’re made up of layers of connected nodes (or 'neurons') that can learn patterns from data.",
  },
  {
    role: "user",
  ...
  },
  {
    role: "bot",
    message:
      "Sure! One common example is in healthcare—neural networks are used to analyze chest X-rays and detect conditions like pneumonia.",
  },
  {
    role: "user",
  ...
  },
  {
    role: "bot",
    message:
      "They can be very accurate, but not perfect. Their performance depends on the quality and amount of training data. In healthcare, they assist doctors but don't replace them.",
  },
  {
    role: "user",
  ...
  },
  {
    role: "bot",
    message:
      "Absolutely! Neural networks are used in self-driving cars, voice assistants like Siri, fraud detection in banking, and even in video game AI.",
  },
  {
    role: "user",
  ...
  },
  {
    role: "bot",
    message:
      "They learn by adjusting internal weights using training data. The goal is to reduce the difference between the predicted output and the correct one — this process is called training or optimization.",
  },
  {
    role: "user",
  ...
  },
  {
    role: "bot",
    message:
      "You're welcome! Let me know if you have more questions about your notes.",
  },
];
...
const MainBlock = () => {
  return (
    <Card className="col-span-12 md:col-span-8 row-span-2">
      <CardHeader>
        <CardTitle>Talk directly with your notes</CardTitle>
        <CardDescription>
...
const CommunityBlock = () => {
  return (
    <Card className="md:col-span-4 col-span-12">
      ...
      <CardFooter className="flex flex-col items-start">
        <div className="font-bold">Find people of similiar interest .</div>
        <div className="text-sm  text-muted-foreground">
